...
namespace _3DPOSRegistrationApp.Database.Migrations.RestaurantDb
{
    ...
    [Migration("20211023190009_AgainUpdateSomeField")]
    partial class AgainUpdateSomeField
    {
            ...
            modelBuilder.Entity("CommonEntityModel.EntityModel.UserStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserStatusId = 1,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2021, 10, 23, 19, 0, 9, 478, DateTimeKind.Utc).AddTicks(8952),
                            StatusType = "Active"
                        },
                        new
                        {
                            UserStatusId = 2,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2021, 10, 23, 19, 0, 9, 478, DateTimeKind.Utc).AddTicks(9481),
