...
namespace _3DPOSRegistrationApp.Database.Migrations.RestaurantDb
{
    ...
    [Migration("20211102213949_StatusTypeUpdate")]
            ...
            modelBuilder.Entity("CommonEntityModel.EntityModel.UserStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserStatusId = 1,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2021, 11, 2, 21, 39, 49, 235, DateTimeKind.Utc).AddTicks(2316),
                            StatusType = "Active"
                        },
                        new
                        {
                            UserStatusId = 2,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2021, 11, 2, 21, 39, 49, 235, DateTimeKind.Utc).AddTicks(2868),
