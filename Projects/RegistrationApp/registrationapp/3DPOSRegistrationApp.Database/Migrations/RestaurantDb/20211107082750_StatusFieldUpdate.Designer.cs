...
namespace _3DPOSRegistrationApp.Database.Migrations.RestaurantDb
{
    ...
    [Migration("20211107082750_StatusFieldUpdate")]
            ...
            modelBuilder.Entity("CommonEntityModel.EntityModel.UserStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserStatusId = 1,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2021, 11, 7, 8, 27, 49, 558, DateTimeKind.Utc).AddTicks(426),
                            StatusType = "Active"
                        },
                        new
                        {
                            UserStatusId = 2,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2021, 11, 7, 8, 27, 49, 558, DateTimeKind.Utc).AddTicks(995),
