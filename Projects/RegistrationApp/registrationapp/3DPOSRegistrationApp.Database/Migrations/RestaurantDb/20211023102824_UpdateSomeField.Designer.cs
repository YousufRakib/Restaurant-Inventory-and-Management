...
namespace _3DPOSRegistrationApp.Database.Migrations.RestaurantDb
{
    ...
    [Migration("20211023102824_UpdateSomeField")]
            ...
            modelBuilder.Entity("CommonEntityModel.EntityModel.UserStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserStatusId = 1,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2021, 10, 23, 10, 28, 24, 111, DateTimeKind.Utc).AddTicks(4229),
                            StatusType = "Active"
                        },
                        new
                        {
                            UserStatusId = 2,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2021, 10, 23, 10, 28, 24, 111, DateTimeKind.Utc).AddTicks(4743),
